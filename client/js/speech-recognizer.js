...
SpeechRecognizer.prototype._init = function() {
  ...
  console.log("CONNECTING to socket.io ... " + this.ws);
  this.socket = io.connect(this.ws);

  console.log("CONNECTING to socket.io COMPLETED!! ");
...
SpeechRecognizer.prototype.start = function() {
  try {
    console.log("SpeechRecognizer.prototype.start");
    this.mic.record();
  } catch (e) {
    console.log("SpeechRecognizer.prototype.start - ERROR: " + e);
    this.onerror(e);
    return;
  }
};
