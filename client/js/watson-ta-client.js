...
//		xmlhttp.onerror = errCallback;
	...
	console.log("OPS iFRAME: " + ops.iframe);
	...
	if(ops.iframe == false){//default is with iframe. consuming app need to explicit set iframe=false to run the widget within the host page 
		...
		console.log("I AM INSIDE ops.iframe FALSE");
		...
		console.log("I AM INSIDE ops.iframe TRUE");

		self = {
			state: "created",
			start : function(callback) {
				console.log("Initiating Loading ... image");
				$('.loading').show();
			...
			_receiveMessage : function(event) {
				...
				console.info("EXECUTING EVENT: " +event.data.type);
				...
				case "dilemma":
					(function(){
						...
						//=========================================================================//
						//*****  THIS IS THE BLOCK THAT GETS RESPONSE BACK FROM api/watson-ta *****//
						//=========================================================================//	
						...
						var okCallback = function(response){
							...
							sessionStorage.watsonTA_Response = response;

							console.log("INSIDE DILEMMA - okCallback: =====|" + JSON.stringify(respObj) + "|=====");
							//alert("TRIGGERING REDIRECTION to VehicleDetails");
							//$("#btnVehicleDetails").trigger("click");
						...
						//=========================================================//
						//*****  THIS IS THE BLOCK THAT INVOKES api/watson-ta *****//
						//=========================================================//
