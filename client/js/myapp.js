 ...
 *****************************************************************************************/
 ...
 var BmWatsonApp = angular.module('BmWatsonApp', ['ui.router','ngResource','userController','navigationController','helpController','vehicleController','userService','vehicleService','bmWatsonController','bmWatsonService']);
 ...
 BmWatsonApp.config(['$stateProvider','$urlRouterProvider', function ($stateProvider,$urlRouterProvider) {
    ...
    .state('userProfile.locationDetails', {
        url: '',
        views: {
            'content': {
                templateUrl: '../templates/user-preferences/locationDetails.html',
                controller: 'UserController'
            }
        }
    })
    .state('userProfile.vehicleDetails', {
        url: '/vehicleDetails',
        views: {
            'content': {
                templateUrl: '../templates/user-preferences/vehicleDetails.html',
                controller: 'UserController'
            }
        }
    })
